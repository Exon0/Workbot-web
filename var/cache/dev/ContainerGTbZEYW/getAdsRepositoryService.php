 ...
 */
class getAdsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdsRepository' shared autowired service.
     *
     * @return \App\Repository\AdsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdsRepository.php';

        return $container->privates['App\\Repository\\AdsRepository'] = new \App\Repository\AdsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
