 ...
 */
class getCaptchaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CaptchaRepository' shared autowired service.
     *
     * @return \App\Repository\CaptchaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CaptchaRepository.php';

        return $container->privates['App\\Repository\\CaptchaRepository'] = new \App\Repository\CaptchaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
