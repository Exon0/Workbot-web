 ...
 */
class getCertifBadgeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CertifBadgeRepository' shared autowired service.
     *
     * @return \App\Repository\CertifBadgeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CertifBadgeRepository.php';

        return $container->privates['App\\Repository\\CertifBadgeRepository'] = new \App\Repository\CertifBadgeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
