 ...
 */
class getEvennementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EvennementRepository' shared autowired service.
     *
     * @return \App\Repository\EvennementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EvennementRepository.php';

        return $container->privates['App\\Repository\\EvennementRepository'] = new \App\Repository\EvennementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
