 ...
 */
class getQuestionReponseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuestionReponseRepository' shared autowired service.
     *
     * @return \App\Repository\QuestionReponseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuestionReponseRepository.php';

        return $container->privates['App\\Repository\\QuestionReponseRepository'] = new \App\Repository\QuestionReponseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
