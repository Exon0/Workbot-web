 ...
 */
class getEntretienRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntretienRepository' shared autowired service.
     *
     * @return \App\Repository\EntretienRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntretienRepository.php';

        return $container->privates['App\\Repository\\EntretienRepository'] = new \App\Repository\EntretienRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
